...
'          Deleted selected file records here will allow those images to be downloaded again from the camera on later transfers. ' + #13 + #10 +
'  NOTE3:  The Download history is stored in the text file OlympusCameraDownloadRecord.txt.  Do not edit this file ' + #13 + #10 +
'  NOTE4:  The list of camera models with known connection URL are stored in the ini file OlympusCameraModels.ini. Do not edit this file.' + #13 + #10 +
